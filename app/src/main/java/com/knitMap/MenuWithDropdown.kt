...
import com.knitMap.discovery.DiscoveryListActivity
import androidx.compose.ui.zIndex
import com.knitMap.map.MapActivity
import com.knitMap.parametre.ParametreActivity
        ...
        AnimatedVisibility(
            ...
            Box(
                ...
                Column {
                    ...
                    MenuItem("Parametre", textColor) {
                        expanded = false
                        context.startActivity(Intent(context, ParametreActivity::class.java))
                    }
